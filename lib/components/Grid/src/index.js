...
const breakpointBoolType = PropTypes.oneOfType([
  PropTypes.bool,
  PropTypes.shape({
    xs: PropTypes.oneOfType(PropTypes.bool),
    sm: PropTypes.oneOfType(PropTypes.bool),
    md: PropTypes.oneOfType(PropTypes.bool),
    lg: PropTypes.oneOfType(PropTypes.bool),
    xl: PropTypes.oneOfType(PropTypes.bool),
  }),
]);
